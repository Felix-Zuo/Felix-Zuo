...
|---|---|---|
| 1 | [AI Factory Operations Intelligence Platform](https://github.com/Felix-Zuo/factory-ops-intelligence-platform) | BOM explosion, material coverage, inventory risk, production notices, line simulation, source-backed factory Q&A, and agent tool traces in one manufacturing operations demo. |
...
- Smart manufacturing and industrial AI applications.
- MES / WMS / ERP implementation and manufacturing systems analysis.
- Production operations digitalization, material visibility, WIP tracking, and supply-production-delivery dashboards.
- AI Agent and RAG workflows grounded in source data, deterministic logic, and human review points.
- Factory simulation and digital-twin-style prototypes for takt, bottlenecks, buffers, and process improvement.

## Practical Workflow

```text
Factory problem
  -> source data and business process mapping
  -> data model and validation rules
  -> deterministic calculation engine
  -> dashboard, report, or production document
  -> AI/Agent explanation with source references
  -> human review and iteration
```

## Current Technical Stack

Python, FastAPI, SQLite, pandas/openpyxl, TypeScript, React, Electron, Vite, local dashboards, CLI tools, structured JSON contracts, agent tool schemas, synthetic manufacturing demo data, and AI-assisted development workflows.
...
Smart Manufacturing Engineer | Industrial AI Application Specialist | Manufacturing Digitalization Specialist | MES/WMS/ERP Implementation Consultant | Manufacturing Systems Analyst | Supply Chain Digitalization Specialist | AI Solutions Consultant for Manufacturing
